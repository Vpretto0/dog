...
### Incorporated from get_image.py example
...
def main(argv):
    ...
    parser.add_argument( ### Incorporated from get_image.py example
    ...
    requests = [
        build_image_request(source, quality_percent=options.jpeg_quality_percent,
                            pixel_format=pixel_format, ### TODO
    ...
    while keystroke != VALUE_FOR_Q_KEYSTROKE and keystroke != VALUE_FOR_ESC_KEYSTROKE:
        ...
        for i in range(len(images)):
            ...
            image, extension = image_to_opencv(images[i], options.auto_rotate) 
