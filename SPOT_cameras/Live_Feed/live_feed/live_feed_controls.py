...
DEFAULT_DISPLAY_RES = (1080, 720)
#DEFAULT_DISPLAY_RES = (2560, 1440)
DEFAULT_DISPLAY_MODE = pygame.DOUBLEBUF | pygame.OPENGL
#DEFAULT_DISPLAY_MODE = pygame.DOUBLEBUF | pygame.OPENGL | pygame.RESIZABLE
#DEFAULT_DISPLAY_MODE = pygame.DOUBLEBUF | pygame.OPENGL | pygame.FULLSCREEN
...
def stitch(robot, options):
    ...
    display = DEFAULT_DISPLAY_RES
    pygame.display.set_mode(display, DEFAULT_DISPLAY_MODE)
