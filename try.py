...
open_terminal(venv="C:/prctm_dog/.venv", command="python C:/prctm_dog/SPOT_cameras/Live_Feed/live_feed/live_feed.py 192.168.80.3 --pixel-format PIXEL_FORMAT_GREYSCALE_U8 -j 100")
